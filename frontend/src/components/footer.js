...
const Footer = () => {
    return (
        <>
            ...
            <footer class=" bg-gray-800 bottom-0 right-0 shadow mt-16 dark:bg-gray-800">
                <div class="w-full mx-auto container md:p-6 p-4 md:flex md:items-center md:justify-between">
                    <div><img className='w-36' src={Logo} alt="" /></div>

                    <span class="text-lg     text-gray-400 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">BusiAnalytix</a>. All Rights Reserved.
                    </span>
